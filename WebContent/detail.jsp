...
<DIV>
	...
	<!--      回复、新帖        -->
	<DIV>
		<A href="post_reply.html"><IMG src="image/reply.gif"  border="0" id=td_post></A> 
		<A href="post_new.html"><IMG src="image/post.gif"   border="0" id=td_post></A>
	</DIV>
	<!--         翻 页         -->
	<DIV>
			...
			<TR class="tr1">
				...
				<TH>
					...
					<DIV class="tipad gray">
						发表：[2007-07-30 10:32] &nbsp;
						最后修改:[2007-07-30 08:37]
						<A href="manage/doDeleteReply.html">[删除]</A>
